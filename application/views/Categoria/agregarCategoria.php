...
<div class='container'>
            ...
            <div class='container-fluid pt-1'>
                <div class='bs-secondary p-4'>
                    <div class='d-flex align-items-center justify-content-between mb-4'>
                        <a class='btn btn-success mb-4' data-bs-toggle='modal' data-bs-target='#exampleModal'><i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;" 
                                            ...
                                            href="<?= base_url('index.php/categoriaController/eliminarCategoria') .'?id_categoria='.$p->id_categoria; ?>">
                                            <i class="bi bi-trash"> </i></a> 

                                            <a class='btn btn-alert-info' 
                                            href="<?= base_url('index.php/categoriaController/edit')."/".$p->id_categoria; ?>">
                                            <i class="bi bi-pencil"> </i></a>                                 
                                    </td>                                
                                </tr>
                                <?php endforeach;?>
    ...
    <div class='modal fade' id='exampleModal' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                    <h1 class='modal-title fs-5' id='exampleModalLabel'>Categoría Bienes</h1>
                    <button type='button' class='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                </div>
                <div class='modal-body'>
                    <div class='contenedor-formulario'>
                        <form method='post' action="<?= base_url('index.php/categoriaController/registroCategoria')?>"
                            enctype='multipart/form-data' class='formulario'>

                            <div class='mb-3'>
                                <label for='categoria' class='form-label'>Categoría</label>
                                <input class='form-control' required='true' placeholder='Escribe la categoría' type='text'
                                    name='descripcion'>
                            </div>
                            <div class='container'>
                                <input class='btn btn-success' type=submit value='Registrar'>
